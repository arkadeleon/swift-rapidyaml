...
class TopLevelDecoderTests: XCTestCase {
    ...
    /// - note: The closing brace of the embedded JSON is indented. rapidyaml rejects a multi-line
    ///         flow container nested under a mapping key when its closer sits at column 0, which
    ///         is how Yams' original reads. See `flowContainersMustNotCloseAtColumnZero`.
