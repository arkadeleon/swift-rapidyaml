...
final class RepresenterTests: XCTestCase, @unchecked Sendable {
    ...
    func testOptional() throws {
        ...
        let keyedNullString = """
            ...
            """
        let keyedNullObject = try RapidYAML.load(yaml: keyedNullString)
        let keyedNullDump = try RapidYAML.dump(object: keyedNullObject)
    ...
    func testEmptyDictionary() throws {
        XCTAssertEqual(try RapidYAML.dump(object: NSDictionary()), "{}\n")
    }
}
